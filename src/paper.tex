...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{../images/connect4}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{../images/connect4.2}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{../images/connect4.3}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{../images/connect4.4}
    \caption{\scriptsize The player with the white tokens wins with four white tokens connected in a line diagonally}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{../images/connect4.5}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{../images/MDP}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{../images/neuron}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{../images/multilayered}
    \vskip 0.2cm
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{../images/feedforward}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.5]{../images/twodim}
    \vskip 0.3cm
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.4]{../images/MSE}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.191]{../images/gradientdescent}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.3]{../images/kernel}
    \vskip 0.2cm
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.36]{../images/cnet}
    \vskip 0.4cm
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.23]{../images/nightrunning}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.52]{../images/Q-K5-L10-R5_vs_mcts2000}
    \caption{Convolutional neural network with kernel size 5 against MCTS-2000}
\end{figure}

\begin{figure}[h]
    \center
    \includegraphics[scale=0.52]{../images/Q-K4-L10-R5_vs_mcts2000}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.52]{../images/Q-K2-L10-R5_vs_mcts2000}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.6]{../images/DQ-K4-L10-R5_vc_mcts2000}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.6]{../images/DQ-K4-L200-R5_vc_mcts2000}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.501]{../images/DQ-K4-L10-R5_vs_mcts2000}
...
\begin{figure}[h]
    \center
    \includegraphics[scale=0.501]{../images/DQ-K4-L10-R3_vs_mcts2000}
